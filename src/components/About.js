...
export const About = () => {
  return (
    <section>
      <h2>About</h2>
      <p>Little Witchery is an online resource center and community dedicated to accessible everyday magic. We believe that a little bit of witchery, infused with practical ritual, imaginative play, and positive intention, can nurture and heal kids (and adults’ inner children.)</p>
      ...
      <div>
        ...
        <div className={styles.creator}>
          <img className={styles.arielPic} src={ariel2} />
          <p>Ariel Kusby is a writer, children&apos;s bookseller, and practicing witch. She is the author of <a>The Little Witch’s Book of Spells</a> (Chronicle Books, August 2020), a magical handbook for children 8 to 12 years old. Her work is inspired by folklore, writing rituals, herbalism, and the power of imaginative play. She lives in Portland, Oregon where she studies magic at the Blue Iris Mystery School. To learn more about her other writing projects, visit <a>www.arielkusby.com</a>.</p>
        </div>
      </div>
    </section>
  );
